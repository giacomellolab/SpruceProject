...
### Statistics on Raw data (Unfiltered, Untransformed, not Normalised)

Violin plot showing distribution of gene counts and UMI counts.

```{r violin-unflt-data, message=FALSE, warning=FALSE, echo=FALSE}
spruce.unfilt <- readRDS("~/Documents/23-02-2021_spruce_new/210222_spruce_raw_data.rds")
...
###Statistics for filtered, normalised data

Violin plots showing distribution of gene counts and UMI counts.

```{r violin-SCT-data, message=FALSE, warning=FALSE, echo=FALSE }
spruce.filt.SCT <- readRDS("~/Documents/23-02-2021_spruce_new/spruce_merged_obj_19-03-2021.rds")
